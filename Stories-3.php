    ...
    <main class="stories">
        ...
        <div class="branch">
            <div class="wrapper-branch">
                <div class="location">
                    <h3 class="text-center2 section-subheading">- Sweet Cake, but Not Its Person -</h3>
                    <img src="Image/card-img5.png" alt="">
                    <p>&emsp;&emsp;&emsp;Hari ini ada tetangga terdekatnya yang ingin memesan satu loyang kue ulang tahun.
                        Bu Ceci, beliau adalah pelanggan setia Mr. Pasya sedari awal TasteManhatta didirikan sebagai usaha kecil-kecilan milik Mr. Pasya. Dengan penuh semangat, Mr. Pasya membuatkan satu loyang <i>Tiramisu Melted Cake</i> sebagai kuenya. Jam menunjukkan pukul 17.00 WIB, tapi sayangnya Bu Ceci tak kunjung mengambil pesanannya
                        yang membuat Mr. Parsya kebingungan.
                    </p>
                    <p>&emsp;&emsp;&emsp;Malamnya, Mr. Parsya pergi ke rumah Bu Ceci untuk mengantarkan cake yang tak kunjung diambil. Disana ia menemukan Bu Ceci sedang merenung bersedih. Ternyata, hari itu anaknya pergi setelah berkunjung dengannya 5 menit dan bertengkar. Padahal, Bu Ceci sudah menyiapkan
                        kue untuk ulang tahun anaknya. Ia sangat bersedih hari itu. Sayangnya, <i><b>Cake is literally sweet, but it's not happen the same way for the person.</b></i>
                    </p>
                    <br><br>
