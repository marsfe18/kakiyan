...
<head>
    ...
    <title>Fill Testimonial | TasteManhatta</title>
    ...
    <main class="testimoni">
        ...
        <div class="together" >
            ...
            <div class="wrapper2" style="height:800px">
                <form action="Testimoni_action.php" method="POST" id="form" name="testimoni_form" onsubmit="return validateInputs()" >
                    <div class="input-box2">
                        <span class="icon" style="background:none;"><ion-icon name="qr-code-sharp" style="color: brown;"></ion-icon></span>
                        <input id="code" type="text" value="<?= $code?>" readonly name="testi" style="color: black;">
                    ...
                    <div class="input-box2">
                        ...
                        <input id="nama" type="text" value="<?= $reserve['fname']?>" readonly name='name' style="color: black;">
                        <label>Name</label>
                        <div class="error"></div>
                    </div>
                    <div class="input-box2">
                    ...
                    <div class="gender-box">
                        ...
                        <div class="gender-option" >
                            <div class="gender">
                                <span>
                                    <input id="gender-male" type="radio" name="order" value="Dine In">
                                </span>
                                <label for="gender-male" style="color: black;">Dine In</label>
                            </div>
                            <div class="gender">
                                <span>
                                    <input id="gender-female" type="radio" name="order" value="Takeaway">
                                </span>
                                <label for="gender-female" style="color: black;">Takeaway</label>
                            </div>
                            <div class="gender" id="other">
                                <span>
                                    <input id="gender-other" type="radio" name="order" checked value="Booking Dine In">
                                </span>
                    ...
                    <div class="input-box2">
                        ...
                        <input id="subjek" type="text" placeholder="Enter your topic subject" name="subject" style="color: black;">
                        <label>Subject</label>
                        <div class="error"></div>
                    </div>
                    <div class="input-box2">
                        <span class="icon" style="background:none;"><ion-icon name="chatbox" style="color: brown;"></ion-icon></span>
                        <textarea id="review" placeholder="Tuliskan review Anda disini." name="review" style="color: black;"></textarea>
                        <label>Review</label>
                        <div class="error"></div>
                    </div>
