    ...
    <main class="stories">
        ...
        <div class="branch">
            <div class="wrapper-branch">
                <div class="location">
                    <h3 class="text-center2 section-subheading">- My Sweetheart Pasta -</h3>
                    <img src="Image/card-img4.png" alt="">
                    <p>&emsp;&emsp;&emsp;Malam yang dingin tidak mengurangi kehangatan dari keluarga Mr. Pasya yang
                        sedang berkumpul merayakan tahun baru bersama. Hari ini anak-anaknya pulang dengan membawa cucu yang amat lucu dan menggemaskan. Sebagai orang tua, tentu saja Mr. Parsya menyambut kedatangan mereka semua dengan hangat mengingat tahun baru ini adalah salah satu yang spesial untuknya setelah TasteManhatta bekerja dengan baik.
                    </p>
                    <p>&emsp;&emsp;&emsp;Cucunya, Danish, yang saat itu berusia lima tahun kemudian meminta kepada kakeknya untuk dibuatkan santapan yang enak. Mr. Parsya kemudian memutar otaknya, ia lalu membuat pasta yang creamy dengan sisa bahan yang ada di kulkas. Anak-anak memakannya dengan lahap membuat Mr. Parsya amat senang. <i>Voila, that's how the Beef Creamy Carbonara Spaghetti has been made, or his grands call it as <b>Sweetheart Pasta</b></i>.
                    </p>
                    <br><br>
                    <p style="font-size: 12px;"><i>Hanafura Ajasahi - Teks Publisher</i></p>    
                </div>
                <div class="layanan">
