    ...
    <main class="stories">
        ...
        <div class="branch">
            <div class="wrapper-branch">
                <div class="location">
                    <h3 class="text-center2 section-subheading">- Burger of A Troops -</h3>
                    <img src="Image/card-img2.png" alt="">
                    <p>&emsp;&emsp;&emsp;Hari itu tidak disangka ada sejumlah tentara yang sedang berkumpul di depan rumah Mr. 
                        Pasya. Katanya, hari  itu adalah hari dimana mereka melakukan uji ketangkasan yang melewati rumah Mr. Parsya di Cianjur. Kebetulan rumahnya memang berada di Kaki Gunung Salak, jadi wajar saja Mr. Parsya melihat hal itu. 
                    </p>
                    <p>&emsp;&emsp;&emsp;Melihat keadaan tentara yang kelelahan di depannya, Mr. Parsya kemudian berinisiatif untuk membuatkan sesuatu yang bisa mengganjal perut mereka karena mereka terlihat lelah sekali. Akhirnya, dengan segala bahan sisa yang ada, Mr. Parsya membuat
                        burger tetapi dengan isian bacon yang tidak umum untuk dibuat. Setelah semua matang dan membagikannya, Mr. Parsya mengambil segigit burger tersebut, campuran bacon dan saus yang ia buat bekerja sama dengan baik serta enak. <b><i>This is how the Beef Bacon Ultimate Burger was made, yash, that's superior is made originally for the troops.</i></b>
                    </p>
                    <br><br>
                    <p style="font-size: 12px;"><i>Ebifura Niku Udon - Teks Publisher</i></p>    
                </div>
                <div class="layanan">
