            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Kopi Kurang Kaffein</a></h4>
                            <span>by MrX</span>
                        </div>
                    </div>
                    <p>Hari itu saya datang dengan tujuan membeli kopi kesukaan saya, sayangnya saya mendapatkan kekecewaan karena tidak sesuai dengan apa yang saya harapkan.
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. MrX </a></h4>
                            <span>Admin-2 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Mohon maaf atas ketidaknyamanan saat mengunjungi kedai kami, untuk kopi sudah dibuat sesuai dengan takaran yang ada. Untuk extra kaffein kami menyediakan
                        addition extra shot espresso. Terima kasih.
                    </p>
                </div>
            </div>
