            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Pelayan Ramah</a></h4>
                            <span>by Saltsugar</span>
                        </div>
                    </div>
                    <p>Hari ini adalah hari difabel sedunia, jadi rencananya aku mau ngajak temenku yang difabel disini. Turns out so great! Pelayanan ramah, waitress bener-bener ngebantu. Great job TasteManhatta!
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. Saltsugar </a></h4>
                            <span>Admin-1 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Terima kasih atas kunjungannya, jangan lupa untuk berkunjung lagi!
                    </p>
                </div>
            </div>
