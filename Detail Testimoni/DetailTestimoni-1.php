            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Makanan yang Saya Pesan Dingin</a></h4>
                            <span>by NajelinaSiffon</span>
                        </div>
                    </div>
                    <p>Saya berkunjung ke outlet TasteManhatta yang ada di Bintaro 2 hari yang lalu, tetapi rib eye premium steak yang disuguhkan kepada Saya
                        sudah dingin dan terasa tidak fresh. Kurang rekomen untuk kalian yang ingin makan steak dengan enak karena ambience yang ditawarkan pun juga so so.
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. NajelinaSiffon </a></h4>
                            <span>Admin-1 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Mohon maaf atas ketidaknyamanan yang diperoleh selama makan di tempat kami, kritikan ini akan menjadi pemacu bagi kamu untuk berusaha lebih baik lagi.
                    </p>
                </div>
            </div>
