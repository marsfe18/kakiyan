            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Juaranya Steak</a></h4>
                            <span>by JustMe</span>
                        </div>
                    </div>
                    <p>Dengan harga yang cukup reasonable, makanan disini amat-sangat worth it.
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. JustMe </a></h4>
                            <span>Admin-2 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Terima kasih atas kunjungannya, semoga TasteManhatta menjadi bagian pengalaman menyenangkanmu, ya!
                    </p>
                </div>
            </div>
