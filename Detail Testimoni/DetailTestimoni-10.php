            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Tenderloin Mantap</a></h4>
                            <span>by Faradilla Saras</span>
                        </div>
                    </div>
                    <p>Tenderloinnya bener-bener melted, bravo TasteManhatta!
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. Faradilla Saras </a></h4>
                            <span>Admin-3 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Terima kasih atas kunjungan Anda di TasteManhatta, semoga Tenderloin Steak kami tetap menjadi favoritmu, yaa! Enjoy Steak with TasteManhatta.
                    </p>
                </div>
            </div>
