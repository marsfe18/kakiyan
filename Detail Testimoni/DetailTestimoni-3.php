            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Masakannya Enak!</a></h4>
                            <span>by CallMeBae</span>
                        </div>
                    </div>
                    <p>Aga kaget sih pas tau Taste Manhatta ternyata asalnya dari Jawa Barat, ga bakal expect sama rasanya yang Western banget! Cocok buat pasangan yang mau
                        spend night fun dinner atau juga bawa anaknya sekalian buat makan malam disini.
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. CallMeBae </a></h4>
                            <span>Admin-1 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Terima kasih atas kunjungannya, semoga pengalaman yang diperoleh disini menyenangkan, ya!
                    </p>
                </div>
            </div>
