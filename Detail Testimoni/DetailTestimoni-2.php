...
<head>
    ...
    <title>Detail Testimonial | TasteManhatta</title>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Sensasi Berkesan Makan di Luar Ruangan</a></h4>
                            <span>by Maysrwa</span>
                        </div>
                    </div>
                    <p>TasteManhatta Jakarta memberikan ambience yang lumayan, sayangnya untuk view outdoor-nya aga sedikit off nih untuk saya. Asap bertaburan dimana-mana membuat
                        suasana makan hari ini disertai debu. Secara keseluruhan sajian enak, pelayan menyenangkan, sayangnya hygiene kurang.
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. Mysrwa </a></h4>
                            <span>Admin-2 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Terima kasih atas kunjungannya, Kami mohon maaf atas ketidaknyamanan yang diperoleh selama makan di tempat kami. Untuk kedepannya akan kami perhatikan lebih lagi mengenai kebersihan toko kami.
                    </p>
                </div>
            </div>
