            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        ...
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Indoor ternyaman yang ada</a></h4>
                            <span>by Kopikir</span>
                        </div>
                    </div>
                    <p>Mantaplah untuk bukber apalagi di bulan puasa kek gini, suasana mendukung, live music, masakan western nya juga top untuk harga segitu.
                    </p>
                </div>
            </div>
            ...
            <div class="single-menu quest">
                <div class="menu-content">
                    <div class="isi">
                        <img src="Image/logo-person.png" alt="">
                        <div class="side">
                            <h4 class="menu-title"><a href="#">Respon untuk Tn./Ny./Nn. Kopikir </a></h4>
                            <span>Admin-2 TasteManhatta</span>
                        </div>
                    </div>
                    <p>Terima kasih atas kunjungan dan reviewnya, jangan lupa untuk berkunjung kembali ya!
                    </p>
                </div>
            </div>
