...
<body class="sajian offer">
    ...
    <main class="reservasi">
        ...
        <h2 class="text-center2" id="special">Form Add Menu</h2>
        <hr>
        <div class="together">
            <img src="./Image/FormAddMenu-2.png" class="wrapper2" alt="" style="height: 650px">
            <div class="wrapper2" style="height: 650px">
                <form action="Menu_edit.php" method="POST" id="form" name="menu_form" enctype="multipart/form-data">
                    ...
                    <div class="input-box2">
                        ...
                        <input id="menu" type="text" placeholder="Enter menu name" name="editNama" value="<?php echo htmlspecialchars($_GET['editNama']); ?>">
                    ...
                    <div class="input-box2 address">
                        ...
                        <div class="column-city">
                            <div class="select-box">
                                <select id="menutype" name="editJenis">
                                    <option hidden value="0">Choose the Appropriate Menu Type</option>
                                    <option value="steak" <?php if ($_GET['editJenis'] === 'steak') echo 'selected'; ?>>Steak</option>
                                    <option value="burger" <?php if ($_GET['editJenis'] === 'burger') echo 'selected'; ?>>Burger</option>
                                    <option value="pizza" <?php if ($_GET['editJenis'] === 'pizza') echo 'selected'; ?>>Pizza</option>
                                    <option value="pasta" <?php if ($_GET['editJenis'] === 'pasta') echo 'selected'; ?>>Pasta</option>
                                    <option value="beverage" <?php if ($_GET['editJenis'] === 'beverage') echo 'selected'; ?>>Beverage</option>
                                    <option value="snack" <?php if ($_GET['editJenis'] === 'snack') echo 'selected'; ?>>Side Dish</option>
                                </select>
                                <div class="error"></div>
                            </div>
                        </div>
                    ...
                    <div class="input-box2">
                        ...
                        <input id="price" type="text" placeholder="Enter menu's price" name="editHarga" value="<?php echo $_GET['editHarga']; ?>">
                    ...
                    <div class="input-box2">
                        ...
                        <textarea id="description" placeholder="Tuliskan deskripsi menu Anda" name="editDeskripsi" required><?php echo htmlspecialchars($_GET['editDeskripsi']); ?></textarea>
