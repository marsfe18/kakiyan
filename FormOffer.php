            ...
            <div class="wrapper2" style="height: 820px">
                <form action="Offer_add.php" method="POST" id="form" name="offer_form" enctype="multipart/form-data">
                    ...
                    <div class="input-box2">
                        ...
                        <input id="offer" type="text" placeholder="Masukkan harga/discount dari offering" name="discount">
                    ...
                    <div class="input-box2">
                        ...
                        <textarea id="description_off" placeholder="Tuliskan deskripsi offer Anda" name="description_off"></textarea>
                    ...
                    <div class="input-box2">
                        ...
                        <textarea id="item" placeholder="Tuliskan item offer. Contoh: pizza, steak" name="item"></textarea>
                        <label>Offering Item</label>
                    </div>

                    <div class="input-box2">
                        <span class="icon" style="background:none;"><ion-icon name="cash-sharp" style="color: brown;"></ion-icon></span>
                        <input id="ogprice" type="number" placeholder="Tuliskan harga originalnya" name="ogprice">
