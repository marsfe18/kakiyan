    ...
    <main class="stories">
        ...
        <div class="branch">
            <div class="wrapper-branch">
                <div class="location">
                    <h3 class="text-center2 section-subheading">- Holy Ribs -</h3>
                    <img src="Image/card-img3.png" alt="">
                    <p>&emsp;&emsp;&emsp;Kejutan awal saat melakukan pengeringan daging, semua yang Mr. Pasya masak
                        menjadi busuk hari itu. Ia melakukan metode dry age yang salah sehingga membuat steak yang ia buat gagal. Dengan segala kesedihannya, ia lalu membuang Steak tersebut. 
                    </p>
                    <p>&emsp;&emsp;&emsp;Mr. Parsya kemudian teringat bahwa ia masih memiliki satu daging Wagyu yang belum ia masak. Ia lalu mengolahnya hanya dengan salt dan blackpaper, tapi Mr. Parsya seperti membuat menu rahasianya dengan itu. Inilah yang kemudian ia sajikan kepada kita sebagai <b><i>Beef Wagyu Premium Steak</i></b>.
                    </p>
                    <br><br>
